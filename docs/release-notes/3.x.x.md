...
- Version 3.8.0 includes input data validation for `eos_cli_config_gen` based on data model schemas.
  By default data issues will be reported as warnings and will not block the playbook. See details [here](../../ansible_collections/arista/avd/roles/eos_cli_config_gen/docs/role-configuration.md#input-variables-validation-settings).
