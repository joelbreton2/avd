...
class DataMergingTestSchema(EosCliConfigGenRootModel):
    ...
    class SomeIndexedListItem(AvdModel):
        ...
        if TYPE_CHECKING:
            def __init__(self, *, name: str | UndefinedType = Undefined, some_int: int | None | UndefinedType = Undefined) -> None:
                """
                SomeIndexedListItem.
    ...
    _fields: ClassVar[dict] = {"some_indexed_list": {"type": SomeIndexedList}, "some_list": {"type": SomeList}}
    ...
    if TYPE_CHECKING:
        def __init__(self, *, some_indexed_list: SomeIndexedList | UndefinedType = Undefined, some_list: SomeList | UndefinedType = Undefined) -> None:
            """
